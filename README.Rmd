...
```{epoxy}
The `universityrankingafrica` data set has {ncol(ranking)} variables and {nrow(ranking)} observations. For an overview of the variable names, see the following table.  
